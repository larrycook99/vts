// VdbPrint.h: defination for class CVdbPrint.
//
//////////////////////////////////////////////////////////////////////

#if !defined(AFX_VdbPrint_H__B83675D5_F325_4A55_B8A4_B22AB09A07AB__INCLUDED_)
#define AFX_VdbPrint_H__B83675D5_F325_4A55_B8A4_B22AB09A07AB__INCLUDED_
...
public:
	...
	void	NewPage				();
	void	ActivateHF			(void(*HFFunc)(CVdbPrint*,int,bool));
	int		StartPrint			();
	void	EndPrint			();
	int		StartPage			();
	void	EndPage				();
...
private:
	...
	void(*m_funcHeadline)(CVdbPrint*,int,bool);	// pointer to function, which is handling the head/footline
};

#endif // !defined(AFX_VdbPrint_H__B83675D5_F325_4A55_B8A4_B22AB09A07AB__INCLUDED_)
