// VdbPrint.cpp: Implementation of class CVdbPrint.
#include "stdafx.h"
#include "stdafx.h"
#include "VdbPrint.h"
...
int CVdbPrint::Dialog (char *PrinterName, int Pages)
{
...
int CVdbPrint::SetMargins (int top, int bottom, int left, int right)
{
...
int CVdbPrint::SetMargins (CRect rect)
{
...
void CVdbPrint::SetDistance (int punkte)
{
	m_Abstand = punkte;
}
...
HPRIVATEFONT CVdbPrint::AddFontToEnvironment (char *FontName, int normalHeight, int bigHeight)
{
...
void CVdbPrint::SetActiveFont (HPRIVATEFONT newfnt)
{
	m_ActiveFont = newfnt;
...
void CVdbPrint::lf (HPRIVATEFONT font, UINT Anz/*=1*/)
{
...
// sets the appearance of a font (see CVdbPrint.h for possible constants)
//
...
void CVdbPrint::SetFace (HPRIVATEFONT font, UINT face)
{
...
void CVdbPrint::Print (HPRIVATEFONT font, CString strText, UINT Format, int left)
{
...
void CVdbPrint::GetDrawDimension (CSize& dim)
{
	dim.cx = m_DimDraw.cx;
	dim.cy = m_DimDraw.cy;
}
...
void CVdbPrint::GetMargins (CRect& Margins)
{
	Margins = m_Margins;
}
...
void CVdbPrint::SetHPos (int Pos)
{
	m_y = Pos;
}
...
//              void HFFunc (CVdbPrint* env, int Page, bool HF);
//              the function has the following parameters
//              env ... handle to the CVdbPrint-object
//              Page ... acutal number of sides
//              HF ..... true=headline is printing, false=footline is printing
void CVdbPrint::ActivateHF (void(*HFFunc)(CVdbPrint*,int,bool))
...
HPRIVATEFONT CVdbPrint::GetActiveFont ()
{
	return (m_ActiveFont);
}
...
int CVdbPrint::InsertBitmap (int ResColor, int fmt, CSize *dest, int left)
{
...
void CVdbPrint::IncrementHPos (int points)
{
	m_y += points;
}


void CVdbPrint::CreateDPICompatibleRect (CRect& rect, int top, int height, int left, int width)
{
	rect.top = CALCY(top);
...
int CVdbPrint::SetEscapement (HPRIVATEFONT font, int Angle)
{
	LOGFONT	log;
...
HANDLE CVdbPrint::DDBToDIB( CBitmap& bitmap, DWORD dwCompression, CPalette* pPal ) 
{
	BITMAP			bm;
	BITMAPINFOHEADER	bi;
