...
octet *APIENTRY eWORD (octet *,word,octet);							//					***236
...
word  APIENTRY eSubscribeCOVService(octet *,dword,dword,word,word,dword);	//			***236
...
word  APIENTRY eGetEnrollmentSummaryService(octet *,word,dword,dword,word,octet *,dword,word,word,word,word,word); //***236
